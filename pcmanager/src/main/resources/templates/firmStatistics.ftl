                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="/factoryReportAction" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-10" style="text-align: center">
                                        <div id="content" style="text-align: center">
                                            <div id="myPieDiv" style="height: 500px; width: 550px;display:inline-block" ></div>
                                        </div>
                                    </div>
                                </div>
