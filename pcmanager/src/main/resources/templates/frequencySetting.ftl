        ...
        jQuery("#s2").change(function() {
            ...
            if(etype!=""&&fat!=""){
                jQuery.ajax({
                    type:"post",
                    url:"/getModelAjax",
                    data:{"etype":etype,"fat":fat},
                    success:function(returnData){
                        var province = jQuery("#s3").first();
                        jQuery.each(returnData,function(index,a){
                            province.append("<option value='"+a.eid+"'>"+a.emodel+"</option>");
                        });
                    }
                })
            }
            ...
            if(eid!=""){
                jQuery.ajax({
                    ...
                    success:function(data){
                        ...
                        var ntr=$("<tr><td>"+data.etype+"</td><td>"+data.efactory+"</td><td>"+data.emodel+"</td><td>"+data.eprice+"</td>" +
