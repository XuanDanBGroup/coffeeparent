                    ...
                    <div class="panel-body">
                        <form action="/doAddItem" method="post" class="form-horizontal" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="不超过40个字符" name="ititle"
                                           id="sname">
                                </div>
                            </div>
                          ...
                          <#--  <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10"  align="center">
                                    <input type="submit" value="添加" id="tj" class="btn btn-blue" style="width: 10%">
                                </div>
                            </div>
                        </form>
                    </div>
