                        ...
                        <form action="/doAddItem" method="post" class="form-horizontal" enctype="multipart/form-data">
                           <input type="hidden" name="itemid" value="${item.itemid}">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="不超过40个字符" name="ititle" value="${item.ititle}"
                                           id="sname">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" cols="5" id="field-5" name="icontent">${item.ititle}</textarea>
                                </div>
                            </div>
                          <#--  <div class="form-group">
