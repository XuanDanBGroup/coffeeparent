                ...
                <div class="panel-body">
                    ...
                    <table id="users" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
							<#list feedbacks as f>
								<tr>
									<td>${f.ftime?datetime}</td>
									<td>${f.hphone}</td>
									<td>${f.fcontent}</td>
									<td>
										<img src="${f.pic1}" alt="反馈图片" width="80px" height="60px">
									</td>
                                    <td>${f.hname}</td>
								</tr>
							</#list>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="field-3" placeholder="手机号码" name="phone">
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="field-3" placeholder="不超过20个字符" name="uname">
								</div>
