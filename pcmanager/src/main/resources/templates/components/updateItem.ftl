            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal" action="/doAddItem" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="field-1" placeholder="新闻标题" name="ititle" value="${item.ititle}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" cols="5" id="field-5" name="icontent">${item.icontent}</textarea>
                        </div>
                    </div>
                    <div class="form-group-separator"></div>
