		...
		<div class="main-content">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <button class="btn btn-info btn-block" style="width: 100px;" onclick="location.href='/addHousehold'">新增户信息</button>
                        ...
                        <tbody>
							<#list users as user>
								<tr>
									...
									<td>
                                        <a href="javascript:;" onclick="showAjaxUpdate(${user.uid});">编辑</a>
										&nbsp;&nbsp;
										<a href="javascript:;" onclick="showRoleList(${user.uid})">删除</a>
									</td>
								</tr>
							</#list>
                        </tbody>
